programa
{
	...
	funcao inicio()
	{	
		 /* Leia as variáveis C e N, respectivamente código e número de horas 
		...
		se(N<=50){
			...
			E=N-50
			escreva("Jornada de trabalho completa e ",mat.arredondar(E, 2)," horas extras feitas \n","Você receberá: R$ ",mat.arredondar(50*SALARIO1+E*SALARIO2,2)," ,sendo ",50*SALARIO1," da sua jornada tradicional"," e ",E*SALARIO2," das horas extras")
